        ...
        success: function(response) {
            ...
            calcularEnvio('Sáenz Peña, Chaco', 'Resistencia, Chaco', function(envio) {
                for (var i = 0; i < cartItems.length; i++) {
                    ...
                    cartItemsHtml += '<tr>';
                    cartItemsHtml += '<td class=" text-dark"><img class="rounded" src="' + cartItems[i].foto + '" alt="' + cartItems[i].nombre_producto + '" style="width: 50px; height: 50px;"></td>';
                    cartItemsHtml += '<td class=" text-dark">' + cartItems[i].nombre_producto + '</td>';
                    cartItemsHtml += '<td class=" text-dark">' + cartItems[i].precio + '</td>';
                    cartItemsHtml += '<td class=" text-dark"><input type="number" class="cantidadInput rounded text-dark" style="border:none; background: rgba(70,70,70,.1); padding-left:10px;" value="'+ cartItems[i].cantidad + '" min="1" data-id="' + cartItems[i].id + '"></td>';
                ...
                $('#cart-summary').html(`
                    <p class=" text-dark">Subtotal: $ ${subtotal}</p>
                    <p class=" text-dark">Envío: $ ${envio}</p>
