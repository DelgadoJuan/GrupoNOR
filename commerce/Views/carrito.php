        ...
        <div class="text-dark mb-5 mt-5 ml-5 mr-5 border-0" style="display: flex;flex:1;flex-wrap:wrap;border:none;">
            <div class="row border-0" style="border:none;">
                ...
                <div class="col-md-4" style="display: flex;flex:2;flex-direction:column;">
                    ...
                    <div id="cart-summary">
                        <p class=" text-dark mb-4" id="cart-subtotal">Subtotal: $<span id="subtotalPrice">0</span></p>
                        <div>
                    ...
                    <button id="pagarButton" href="./pago.php" class="boton-checkout" style="background-color:rgb(6, 160, 227);border:none;opacity:1;margin-top:auto" disabled></button>
                </div>
            </div>
        </div>
