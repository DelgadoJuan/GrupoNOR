...
<footer class="footer">
  <div class="card mt-5 pt-5" style="display:flex; flex-direction:row; box-shadow:none; padding: 0 1em; border-top: 2px solid rgba(80,80,80,.2)">

    <div class="card" style="box-shadow:none; flex:1;">
      <a class="navbar-brand mr-4" href="../Views/index.php">
        <!-- Icono de la empresa -->
        <img src="../Util/Assets/Grupo Nor Logo 2 [Recuperado].png" alt="Company Logo" class=""
          style="opacity: 1; width: 8em; margin-left:1em">
      </a>
    </div>
    <div class="card" style="
      ...
      <a href="https://www.instagram.com/gruponor.ventas/" style="color:black">
      ...
      <a href="mailto:gruponor.sas.chaco@gmail.com" style="color:black">
      ...
      <a href="https://www.facebook.com/grupo.nor.arg/" style="color:black">
