            ...
            <div class="col-md-12">
                <div class="card" style="box-shadow: none;border:none;">
                    <div class="card-header mb-0" style="box-shadow: none;border:none;">
                        <h3 class="card-title mb-0" style="font-weight: 700; font-size:1.75em; ">Inventario Actual</h3>
                    </div>
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-5">
                            <!-- Agregar un input para el filtrado por nombre -->
                            <input type="text" id="filterName" class="form-control" style=" flex 2; width:100%; max-width: 25em; border:none; background: rgba(200,200,200,.3)" placeholder="Filtrar por nombre">
                            <!-- Botón para abrir el modal -->
                            <div style="gap 1em">
                                <button type="button" class="btn btn-success mr-2" style="justify-content: right;" data-toggle="modal" data-target="#productModal">
                                    Agregar Producto
                                </button>
                        ...
                        <table id="inventoryTable" class="table table-striped">
                            <thead>
                                <tr>
                                    <th data-columna="p.nombre"><p style="opacity:.4">Nombre <i class="fas fa-sort"></i></th>
                                    <th data-columna="c.nombre"><p style="opacity:.4">Categoría <i class="fas fa-sort"></i></th>
                                    <th data-columna="p.precio_unitario"><p style="opacity:.4">Precio (u) <i class="fas fa-sort"></i></th>
                                    <th data-columna="p.costo_unidad"><p style="opacity:.4">Costo (u) <i class="fas fa-sort"></i></th>
                                    <th data-columna="p.sector"><p style="opacity:.4">Sector <i class="fas fa-sort"></i></th>
                                    <th data-columna="p.descripcion"><p style="opacity:.4">Descripción <i class="fas fa-sort"></i></th>
                                    <th data-columna="p.fecha_registro"><p style="opacity:.4">Fecha de Registro <i class="fas fa-sort"></i></th>
                                    <th data-columna="p.fecha_actualizacion"><p style="opacity:.4">Fecha de Actualización <i class="fas fa-sort"></i></th>
                                    <th data-columna="p.cantidad_disponible"><p style="opacity:.4">Existencia <i class="fas fa-sort"></i></th>
                                    <th data-columna="p.estado"><p style="opacity:.4">Estado <i class="fas fa-sort"></i></th>
                                    <th><p style="opacity:.4">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
